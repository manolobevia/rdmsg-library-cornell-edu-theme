  ...
  <div class="container">
    <div class="row">
      <div class="cornell-logo">
        <div class="cu-logo">
          <img src="/sites/all/themes/rdmsgtheme/img/layout/cul-logo-white.gif">
...
<div class="navbar">
    <div class="navbar-header">
      ...
      <div class="mobile-insignia visible-xs">
        <a href="http://www.cornell.edu"><img src="/sites/all/themes/rdmsgtheme/img/layout/insignia.png" alt=""></a>
      </div>
      ...
      <div class="container">
        <div class="row">
         <div class="col-sm-4 pull-left">
            <a href="/"><img src="/sites/all/themes/rdmsgtheme/img/rdmsgnewlogo.jpg" class="img-responsive"></a>
          </div>
         <div class="col-sm-8 pull-right ">
            
               <div class="row"> <?php print render($page['search-box']); ?></div>
              <div class="row"><div class="nav navbar-nav pull-right nav-rdmsg" >
